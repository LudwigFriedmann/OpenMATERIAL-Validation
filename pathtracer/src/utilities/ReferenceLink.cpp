...
///
/// @details The function checks if the json object has the property
...
/// @brief Create ReferenceLink object from json object.
///
/// @details If the json object does not contain OpenMaterial_reference_link, a
